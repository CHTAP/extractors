        ...
        with codecs.open(fp, encoding=self.encoding) as tsv:
            for ind, line in enumerate(tsv):
                if ind == 0:
                    continue
                try:
#                     (id,uuid,memex_id,memex_content_typecrawl_data,memex_crawler,memex_doc_type,memex_extracted_metadata,memex_extracted_text,memex_extractions,memex_raw_content,memex_team,memex_timestamp,memex_type,memex_url,memex_version,domain,type,url,content,extractions)
